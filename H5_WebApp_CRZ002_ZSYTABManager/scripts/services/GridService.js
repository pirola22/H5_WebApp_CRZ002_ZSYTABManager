    ...
    (function (application) {
        var GridService = (function () {
            ...
            GridService.prototype.clearGridStates = function () {
                var _this = this;
                var gridIds = ["sampleGrid1", "ZSYTABListGrid", "customerMasterListGrid", "itemGroupListGrid"];
            ...
            GridService.prototype.getZSYTABListGrid = function () {
                var ZSYTABListGrid = angular.copy(this.baseGrid);
                var gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\"TOOLTIP\"><span class=\"h5-link\" ng-click=\"grid.appScope.ZSYTABModule.loadZSYTABRecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
                ZSYTABListGrid.columnDefs = [
                    { name: "PK01", displayName: this.languageService.languageConstants.get('Custom Table'), cellTemplate: gridLinkCellTemplate, enableCellEdit: false },
                    ...
                    { name: "AL33", displayName: this.languageService.languageConstants.get('Port'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                    { name: "AL35", displayName: this.languageService.languageConstants.get('Application Name'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                ];
                ZSYTABListGrid.exporterCsvFilename = "sample_list.csv";
                ZSYTABListGrid.exporterPdfFilename = "sample_list.pdf";
                ZSYTABListGrid.saveSelection = false;
                return ZSYTABListGrid;
            };
