module h5.application {
    ...
    export class GridService {
        ...
        public clearGridStates() {
            let gridIds = ["sampleGrid1", "ZSYTABListGrid", "customerMasterListGrid", "itemGroupListGrid"]; //added
        ...
        public getZSYTABListGrid(): IUIGrid {
            let ZSYTABListGrid: IUIGrid = angular.copy(this.baseGrid);
            let gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\"TOOLTIP\"><span class=\"h5-link\" ng-click=\"grid.appScope.ZSYTABModule.loadZSYTABRecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
