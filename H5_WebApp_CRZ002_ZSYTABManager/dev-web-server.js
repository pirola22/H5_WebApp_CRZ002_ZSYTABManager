...
var h5Credentials = "monchj12@tac:l3n0v0"; //H5 User Credentials

console.log('Starting web server at localhost:' + port + '/mne/apps/crz002');
connect().use('/mne/apps/crz002', serveStatic(path)).listen(port);
